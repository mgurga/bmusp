...
RAYGUIDEF float GuiProgressBar(Rectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, bool textContained);  // Progress Bar control, shows current progress value
...
float GuiSliderPro(Rectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, int sliderWidth, bool textContained)
{
    GuiControlState state = guiState;
...
float GuiProgressBar(Rectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, bool textContained)
{
    GuiControlState state = guiState;
